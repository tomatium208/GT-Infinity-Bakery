ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembler("kjs/electronic_mv")
        .inputFluids("gtceu:tin 144")
        .itemInputs('3x gtceu:basic_electronic_circuit', '2x gtceu:diode', '1x gtceu:phenolic_printed_circuit_board', "8x #forge:fine_wires/steel")
        .itemOutputs("gtceu:good_electronic_circuit")
        .EUt(GTValues.VHA[GTValues.LV])

    event.recipes.gtceu.assembler("kjs/electronic_mv_soldering_alloy")
        .inputFluids("gtceu:soldering_alloy 72")
        .itemInputs('3x gtceu:basic_electronic_circuit', '2x gtceu:diode', '1x gtceu:phenolic_printed_circuit_board', "8x #forge:fine_wires/steel")
        .itemOutputs("gtceu:good_electronic_circuit")
        .EUt(GTValues.VHA[GTValues.LV])

    circuitFromCircuitAssembler("gtceu:good_electronic_circuit",
        [
            '3x gtceu:basic_electronic_circuit',
            '2x gtceu:diode',
            '1x gtceu:phenolic_printed_circuit_board'
        ],
        144, GTValues.VHA[GTValues.LV], 200, "electronic_mv"
    )
