ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu
        .chemical_reactor("kjs/casing_invar_heatproof")
    ...
    event.recipes.gtceu
        .assembler("kjs/fission_rod")
        .inputFluids("gtceu:glass 144")
        .itemInputs(
            "gtceu:hv_machine_casing",
            "4x #forge:rods/stainless_steel",
